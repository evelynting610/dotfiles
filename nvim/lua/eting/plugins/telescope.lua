return {
    ...
    vim.keymap.set("n", "<leader>fj", custom_actions.live_grep_java, {})
    vim.keymap.set("n", "<leader>fr", custom_actions.live_grep_ruby, {})
    vim.keymap.set("n", "<leader>fjs", custom_actions.live_grep_js, {})

...
function M.live_grep_ruby()
  require("telescope.builtin").live_grep({
    glob_pattern = { "*.rb", "!*spec.rb" },
    prompt_title = "Live Grep Ruby Files",
  })
end

function M.live_grep_java()
  require("telescope.builtin").live_grep({
    glob_pattern = { "*.java", "!*Test.java" },
    prompt_title = "Live Grep Java Files",
  })
end
